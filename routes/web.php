...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('/productDetails/{id}','WebController@productdetails')->name('productDetails');
    Route::get('/shoplist','WebController@shoplist')->name('shoplist');
    Route::get('/myaccount','WebController@myaccount')->name('myaccount');
    Route::get('/wishlist','WebController@wishlist')->name('wishlist');
    Route::get('/compareProduct','WebController@compareProduct')->name('compareProduct');
