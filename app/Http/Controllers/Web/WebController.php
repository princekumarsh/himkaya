...
class WebController extends Controller
{
    ...
    {   //dd(auth('customer')->user());
        // $password = Hash::info('$2y$10$DBze8gx53GtT.V5o.VEV/Ot1z8j3DUNaHTBSAyZncWyk40BYWiZpW');
        // dd($password->algoName);
        ...
        $categories = Category::where(['position'=> 0,'home_status'=> 1])->priority()->take(11)->get();
        ...
        // dd($home_categories,$topRated, $deal_of_the_day, $featured_products, $bestSellProduct, $latest_products);
        return view('web-views.home',
                    compact('featured_products','flash_deals', 'topRated', 'bestSellProduct', 'latest_products', 'categories', 'brands', 'deal_of_the_day', 'top_sellers', 'home_categories', 'brand_setting')
                );
    }

    public function productdetails($id){
        $latest_produ = Product::with(['reviews'])->active()->orderBy('id', 'desc')->take(8)->get();
        $latest_products = Product::with(['reviews'])->active()->orderBy('id', 'desc')->where('id',$id)->get();
        $categories = Category::where(['position'=> 0,'home_status'=> 1])->priority()->take(11)->get();
        ...
        return view('web-views.product_details',compact('topRated','latest_produ'));
    }
    ...
    public function shoplist(){
        ...
        return view('web-views.shop',compact('topRated'));
    }

    // public function cartlist(){
    //     return view('web-views.cartlist');
    // }

    // public function wishlist(){
    //     return view('web-views.wishlist');
    // }

    // public function myaccount(){
    //     return view('web-views.myAccount');
    // }
    ...
    //     return view('web-views.shop_cart1');
    ...
    public function product($slug)
    {
        ...
        if ($product != null) {
            ...
            return view('web-views.products.details', compact('product', 'countWishlist', 'countOrder', 'relatedProducts', 'deal_of_the_day','topRated'));
        }
