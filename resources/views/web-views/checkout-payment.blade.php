                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            ...
                                            <input type="hidden" name="amount"
                                                value="{{\App\CPU\Convert::usdTozar($amount*100)}}"> {{-- required in
                                            kobo --}}
                                            <input type="hidden" name="quantity" value="1">
                                            <input type="hidden" name="currency"
                                                value="{{\App\CPU\Helpers::currency_code()}}">
                                            <input type="hidden" name="metadata"
                                                value="{{ json_encode($array = ['key_name' => 'value',]) }}"> {{-- For
                                            other necessary things you want to add to your payload. it is optional
                                            though --}}
        ...
        <div class="modal-content">
            ...
            <form action="{{route('checkout-complete-wallet')}}" method="get" class="needs-validation">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                            ...
                            @if ($remain_balance<0) <label class="__color-crimson">{{\App\CPU\translate('you do not have
                                sufficient balance for pay this order!!')}}</label>
                                @endif
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn--primary" {{$remain_balance>0?
