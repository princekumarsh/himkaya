            ...
            <div class="shopping-cart-wrap">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="shopping-checkout-content">
                            <div class="checkout-accordion" id="accordionExample">
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item __inline-57"
                                                ...
                                                <span class="checkmark" style="margin-{{Session::get('direction') === "
                                                    rtl" ? 'left' : 'right' }}: 10px"></span>
                                                <label class="badge"
                                                ...
                                                <div class="d-flex">
                                                    <div class="w-0 flex-grow-1 justify-content-between">
                                                        ...
                                                        <span>{{ \App\CPU\translate('address')}} :
                                                            {{$address['address']}},
                                                            {{$address['city']}}, {{$address['zip']}}.</span>
                                                    </div>
                                                    <div class="">
                                                        <a href="{{ route('address-edit', ['id' => $address->id]) }}"
                                                            title="{{ \App\CPU\translate('edit_address')}}"
                                                            class="mt-2"><i class="fa fa-edit fa-lg"></i></a>
                                                    </div>
                                                </div>
                                            </li>
                                            @endforeach
                                            <li class="list-group-item" @if($shipping_addresses->count() >
                                                0)onclick="anotherAddress()"@endif>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="address_type">
                                                                    ...
                                                                    <option value="others">{{
                                                                        \App\CPU\translate('Others')}}</option>
                                                                </select>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="exampleInputEmail1">{{
                                                                    \App\CPU\translate('City')}}<span
                                                            ...
                                                            <div class="form-group">
                                                                <label for="state">{{ \App\CPU\translate('State')}}
                                                                    <span style="color: red">*</span></label>
                                                                <input type="text" class="form-control" id="state"
                                                                    name="state" placeholder="Enter yuor state ">
                                                            </div>
                                                            ...
                                                            <div class="form-check"
                                                                style="padding-{{Session::get('direction') === " rtl"
                                                                ? 'right' : 'left' }}: 1.25rem;">
                                                                <input type="checkbox" name="save_address"
                                                                    class="form-check-input" id="exampleCheck1">
                                                                <label class="form-check-label" for="exampleCheck1"
                                                                    style="padding-{{Session::get('direction') === "
                                                                    rtl" ? 'right' : 'left' }}: 1.09rem">
                                                            ...
                                                            <button type="submit" class="btn btn--primary"
                                                                style="display: none" id="address_submit"></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
                                ...
                                <div style="display: {{$billing_input_by_customer?'':'none'}}">
                                    ...
                                    @if($physical_product_view)
                                    <div class="form-check mb-2" style="padding-{{Session::get('direction') === " rtl"
                                        ? 'right' : 'left' }}: 1.25rem;">
                                        <input type="checkbox" id="same_as_shipping_address"
                                            onclick="hide_billingAddress()" name="same_as_shipping_address"
                                            ...
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item __inline-57"
                                                    ...
                                                    <input type="radio" name="billing_method_id"
                                                        id="bh-{{$address['id']}}" value="{{$address['id']}}">
                                                    <span class="checkmark"
                                                        style="margin-{{Session::get('direction') === " rtl" ? 'left'
                                                        : 'right' }}: 10px"></span>
                                                    <label class="badge"
                                                        style="background: {{$web_config['primary_color']}}; color:white !important;">{{$address['address_type']}}</label>
                                                    <small>
                                                ...
                                                @endforeach
                                                <li class="list-group-item" @if($billing_addresses->count() > 0)
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        placeholder="Enter yuor billing state ">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">{{
                                                                        \App\CPU\translate('address')}}<span
                                                                ...
                                                                <input type="hidden" name="billing_longitude"
                                                                    class="form-control" placeholder="Ex : 103.344322"
                        ...
                        <div class="mt-3 d-flex btn-full-max-sm align-items-center __gap-6px flex-wrap justify-content-between">
                            ...
                            <a onclick="proceed_to_next()" class="btn btn-primary pull-{{Session::get('direction') === " rtl" ? 'left' : 'right' }}">
                                <span class="d-none d-sm-inline" style="">{{ \App\CPU\translate('proceed_payment')}}</span>
